...
public class MyWorld extends World {
	...
	public MyWorld() {
		...
		super(600, 400, 1);
		setPaintOrder(Text.class, Counter.class, Fly.class, Mouse.class, Dot.class);
		...
		counter = new Counter("Dots eaten: ");
		addObject(counter, 520, 20);
	...
	public void removeDots(Collection<Dot> dots) {
		counter.add(dots.size());
		removeObjects(dots);
	}
